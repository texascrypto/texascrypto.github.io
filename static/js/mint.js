  ...
  $('.acc__title').click(function(j) {
    ...
    j.preventDefault();
        ...
        main = setInterval(function() { 
          if (counting) {
              ...
              if (mh > 10) {
                ...
                if (month != 18) {
                  var timeString = "Public Sale ended, see you all at the events!";
                  document.getElementsByClassName("mint")[0].disabled = true;
                } else {
                  var timeString = "<a href='/'>Refresh</a> when the public sale begins at "+
        ...
        document.addEventListener('DOMContentLoaded', function() {
          countDownTimer('March 18, 2021 12:00:00-5:00');
        }, false);